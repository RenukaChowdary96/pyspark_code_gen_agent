...
# Define target Delta Lake table name and path
...
try:
    ...
    print(f"Customers null count: {customers_null_count}")
    print(f"Products null count: {products_null_count}")
    print(f"Sales null count: {sales_null_count}")

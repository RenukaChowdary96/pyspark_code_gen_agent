# ETL Pipeline - 20250904_184925

## Files Generated
- `etl_pipeline_20250904_184925.py` - Python ETL script
- `etl_pipeline_20250904_184925.ipynb` - Jupyter notebook with documentation
- `etl_pipeline_20250904_184925_README.md` - This README file
...
3. Run the pipeline:
   ```bash
   spark-submit etl_pipeline_20250904_184925.py
   ```

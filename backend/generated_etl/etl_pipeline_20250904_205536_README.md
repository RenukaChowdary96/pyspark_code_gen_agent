# ETL Pipeline - 20250904_205536

## Files Generated
- `etl_pipeline_20250904_205536.py` - Python ETL script
- `etl_pipeline_20250904_205536.ipynb` - Jupyter notebook with documentation
- `etl_pipeline_20250904_205536_README.md` - This README file
...
3. Run the pipeline:
   ```bash
   spark-submit etl_pipeline_20250904_205536.py
   ```

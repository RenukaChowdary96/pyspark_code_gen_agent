# ETL Pipeline - 20250904_173710

## Files Generated
- `etl_pipeline_20250904_173710.py` - Python ETL script
- `etl_pipeline_20250904_173710.ipynb` - Jupyter notebook with documentation
- `etl_pipeline_20250904_173710_README.md` - This README file

## Configuration
Text: Text file (5746 chars)
...
3. Run the pipeline:
   ```bash
   spark-submit etl_pipeline_20250904_173710.py
   ```
